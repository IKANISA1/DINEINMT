...
bHk(d){return C.l.qL(D.aOg,new B.aAK(d),new B.aAL())},
bHi(d){var x
...
bHj(d){var x
$label0$0:{if("manual"===d){x=D.f_
break $label0$0}if("ai_gemini"===d){x=D.aRZ
break $label0$0}x=D.ul
break $label0$0}return x},
...
s=A.hK(a2.i(0,"highlight_rank"))
s=s==null?e:C.p.cJ(s)
if(s==null){s=A.hK(a2.i(0,"highlightRank"))
...
h=A.hK(a2.i(0,"image_attempts"))
h=h==null?e:C.p.cJ(h)
if(h==null)h=0
g=A.et(a2.i(0,"is_available"))
f=y.L.a(a2.i(0,"tags"))
f=f==null?e:J.tn(f,y.N)
if(f==null)f=C.b7
...
p=y.P
x=3
return A.h(A.qr("generate_menu_item_image",null,q,!1),$async$E6)
case 3:t=p.a(i)
q=A.a8(t.i(0,"status"))
if(q==null)q="unknown"
A.a8(t.i(0,"itemId"))
...
case 3:t=q.eR(p.a(f),new B.aAZ(),y.g)
s=A.Z(t,t.$ti.h("an.E"))
...
case 3:t=o.eR(n.a(g),new B.aB0(),y.g)
q=A.Z(t,t.$ti.h("an.E"))
x=4
...
a0=y.j
x=7
return A.h(new A.a2r(m.a,m.b,!1,m.d,m.e,m.f,m.r,m.w,m.x,m.y,A.jl("supabase.postgrest")).aVW(j,!1,k),$async$Ez)
case 7:s=a0.a(a3)
r=A.A(l,y.S)
for(m=J.bb(s),l=y.P;m.t();){q=m.gN()
p=l.a(q)
o=A.a8(J.ch(p,"menu_item_id"))
k=A.hK(J.ch(p,"total_ordered"))
f=k==null?null:C.p.cJ(k)
n=f==null?0:f
if(o!=null&&n>0)J.lQ(r,o,n)}v=r
x=1
break
u=2
x=6
...
t=A.ns(new A.bt(o,t),new B.aAQ(),t.h("H.E"),y.P)
o=A.Z(t,A.r(t).h("H.E"))
x=3
...
for(;;)switch(x){case 0:x=2
return A.h(A.jq(),$async$wH)
case 2:n=g
u=A.oV(n.a.gcl(),y.N),t=u.ga7(0),u=new A.f1(t,new B.aAW(),A.r(u).h("f1<1>"))
case 3:if(!u.t()){x=4
break}s=t.gN()
r={}
q=v.H7(n,s)
...
for(;;)switch(x){case 0:x=2
return A.h(A.jq(),$async$wo)
case 2:n=f
u=n.a,t=A.oV(u.gcl(),y.N),s=t.ga7(0),t=new A.f1(s,new B.aAT(),A.r(t).h("f1<1>"))
case 3:if(!t.t()){x=4
break}r=s.gN()
q=v.H7(n,r)
p=A.a_(q).h("aq<1>")
...
if(w==null||w.length===0)return D.tL
x=J.eR(y.j.a(C.aN.mg(w,null)),new B.aAS(),y.g)
x=A.Z(x,x.$ti.h("an.E"))
return x}}
var z=a.updateTypes(["aw<f,@>(by)","by(@)","by(by)","y(by)","y(nv)","nv()"])
B.aAK.prototype={
...
D.tL=x([],y.m)
D.L6=new B.ku(0,"food")
D.L7=new B.ku(1,"drinks")
D.ky=new B.nv(0,"pending")
D.on=new B.nv(1,"generating")
D.io=new B.nv(2,"ready")
D.L8=new B.nv(3,"failed")
D.aOg=x([D.ky,D.on,D.io,D.L8],A.B("x<nv>"))
D.L0=new A.bW(C.cK,[],A.B("bW<f,u>"))
D.ul=new B.LY(0,"unknown")
D.f_=new B.LY(1,"manual")
D.aRZ=new B.LY(2,"aiGemini")})();(function lazyInitializers(){var x=a.lazyFinal
x($,"bWV","bzr",()=>new B.aAJ())
x($,"bWW","o9",()=>new B.aAP())})()};
(a=>{a["6xMt5aVv7qU3GNOorbMo0g5TU50="]=a.current})($__dart_deferred_initializers__);