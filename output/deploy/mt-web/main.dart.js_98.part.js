...
bI8(d){return C.l.qR(D.aOr,new B.aBd(d),new B.aBe())},
bI6(d){var x
...
bI7(d){var x
$label0$0:{if("manual"===d){x=D.f1
break $label0$0}if("ai_gemini"===d){x=D.aSe
break $label0$0}x=D.up
break $label0$0}return x},
...
x=A.eu(a2.i(0,"admin_managed"))
if(x==null)x=A.eu(a2.i(0,"adminManaged"))
w=A.aU(a2.i(0,"name"))
...
if(u==null)u=e
if(u==null)u=0
t=A.eu(a2.i(0,"price_hidden"))
s=A.fw(a2.i(0,"highlight_rank"))
s=s==null?e:C.q.cu(s)
if(s==null){s=A.fw(a2.i(0,"highlightRank"))
...
gul(){var x=this.Q
return x!=null&&C.m.U(x).length!==0},
...
if(s!=null)t.push(s)
C.l.L(t,this.gaOD())
for(x=J.bc(this.dx);x.t();){w=C.m.U(x.gN())
...
p=y.P
x=3
return A.h(A.m3("generate_menu_item_image",null,q,!1),$async$Ed)
case 3:t=p.a(i)
q=A.a5(t.i(0,"status"))
if(q==null)q="unknown"
A.a5(t.i(0,"itemId"))
...
p=y.j
x=3
return A.h(A.ew().$3$payload$useAdminSession("get_menu_items",A.a_(["venueId",d],y.N,y.z),!1),$async$vo)
case 3:t=q.em(p.a(f),new B.aBs(),y.g)
s=A.Y(t,t.$ti.h("am.E"))
...
return A.h(A.ew().$3$payload$useAdminSession("get_menu_item_by_id",A.a_(["itemId",d],y.N,y.z),!1),$async$Et)
case 3:u=f
if(u==null){v=null
x=1
...
u.L(0,v.we())
x=2
return A.h(A.ew().$2$payload("toggle_menu_item_availability",u),$async$E0)
case 2:x=3
...
q=y.P
x=3
return A.h(A.ew().$2$payload("create_menu_item",s),$async$BL)
case 3:t=r.Dy(q.a(f))
x=4
...
s.L(0,v.we())
x=2
return A.h(A.ew().$3$payload$useAdminSession("update_menu_item",s,!1),$async$yF)
case 2:u=g
x=y.P.b(u)?3:4
break
case 3:t=B.Dy(u)
...
for(t=e.length,s=0;s<e.length;e.length===t||(0,A.M)(e),++s){r=C.m.U(e[s])
...
n=y.j
x=3
return A.h(A.ew().$2$payload("set_menu_item_highlights",t),$async$z8)
case 3:t=o.em(n.a(g),new B.aBu(),y.g)
q=A.Y(t,t.$ti.h("am.E"))
x=4
...
u.L(0,v.we())
x=2
return A.h(A.ew().$2$payload("delete_menu_item",u),$async$BX)
case 2:x=3
...
t.L(0,v.we())
x=2
return A.h(A.ew().$3$payload$useAdminSession("update_menu_item",t,!1),$async$z9)
case 2:x=3
...
a0=y.j
x=7
return A.h(new A.a2D(m.a,m.b,!1,m.d,m.e,m.f,m.r,m.w,m.x,m.y,A.js("supabase.postgrest")).aWA(j,!1,k),$async$EH)
case 7:s=a0.a(a3)
r=A.A(l,y.S)
for(m=J.bc(s),l=y.P;m.t();){q=m.gN()
p=l.a(q)
o=A.a5(J.ch(p,"menu_item_id"))
k=A.fw(J.ch(p,"total_ordered"))
f=k==null?null:C.q.cu(k)
n=f==null?0:f
if(o!=null&&n>0)J.l3(r,o,n)}v=r
x=1
break
u=2
x=6
...
t=A.nv(new A.bt(o,t),new B.aBj(),t.h("H.E"),y.P)
o=A.Y(t,A.r(t).h("H.E"))
x=3
...
for(;;)switch(x){case 0:x=2
return A.h(A.jy(),$async$wI)
case 2:n=g
u=A.oZ(n.a.gcm(),y.N),t=u.ga7(0),u=new A.f2(t,new B.aBp(),A.r(u).h("f2<1>"))
case 3:if(!u.t()){x=4
break}s=t.gN()
r={}
q=v.Hh(n,s)
...
for(;;)switch(x){case 0:x=2
return A.h(A.jy(),$async$wp)
case 2:n=f
u=n.a,t=A.oZ(u.gcm(),y.N),s=t.ga7(0),t=new A.f2(s,new B.aBm(),A.r(t).h("f2<1>"))
case 3:if(!t.t()){x=4
break}r=s.gN()
q=v.Hh(n,r)
p=A.a0(q).h("aq<1>")
...
if(w==null||w.length===0)return D.tP
x=J.em(y.j.a(C.aH.ky(w,null)),new B.aBl(),y.g)
x=A.Y(x,x.$ti.h("am.E"))
return x}}
var z=a.updateTypes(["av<f,@>(bu)","bu(@)","bu(bu)","y(bu)","y(ny)","ny()"])
B.aBd.prototype={
...
D.tP=x([],y.m)
D.La=new B.ky(0,"food")
D.Lb=new B.ky(1,"drinks")
D.kA=new B.ny(0,"pending")
D.oo=new B.ny(1,"generating")
D.is=new B.ny(2,"ready")
D.Lc=new B.ny(3,"failed")
D.aOr=x([D.kA,D.oo,D.is,D.Lc],A.B("x<ny>"))
D.L4=new A.bT(C.cK,[],A.B("bT<f,u>"))
D.up=new B.M3(0,"unknown")
D.f1=new B.M3(1,"manual")
D.aSe=new B.M3(2,"aiGemini")})();(function lazyInitializers(){var x=a.lazyFinal
x($,"bXM","bAd",()=>new B.aBa())
x($,"bXO","oc",()=>new B.aBi())})()};
(a=>{a["5EM4QzrVTXQdswp1nA1bhLf7cSE="]=a.current})($__dart_deferred_initializers__);