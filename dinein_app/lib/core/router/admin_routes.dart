...
Future<void> _loadAlreadyAvailableAdminLibrary() async {}
...
final List<RouteBase> adminRoutes = [
  GoRoute(
    ...
    builder: (context, state) => DeferredWidget(
      libraryLoader: adminloginscreen.loadLibrary,
      createWidget: (_) => adminloginscreen.AdminLoginScreen(),
    ),
  ),
  ...
  ShellRoute(
    builder: (context, state, child) => DeferredWidget(
      libraryLoader: _loadAlreadyAvailableAdminLibrary,
      createWidget: (_) => adminshell.AdminShell(child: child),
    ),
    routes: [
      GoRoute(
        ...
        pageBuilder: (context, state) => buildFadeSlidePage(
          state,
          DeferredWidget(
            libraryLoader: admindashboardscreen.loadLibrary,
            createWidget: (_) => admindashboardscreen.AdminDashboardScreen(),
          ),
        ),
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) => buildFadeSlidePage(
          state,
          DeferredWidget(
            libraryLoader: adminvenuesscreen.loadLibrary,
            createWidget: (_) => adminvenuesscreen.AdminVenuesScreen(),
          ),
        ),
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) => buildFadeSlidePage(
          state,
          DeferredWidget(
            libraryLoader: adminvenuedetailscreen.loadLibrary,
            createWidget: (_) =>
                adminvenuedetailscreen.AdminVenueDetailScreen(),
          ),
        ),
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return buildFadeSlidePage(
            ...
            DeferredWidget(
              libraryLoader: adminvenuedetailscreen.loadLibrary,
              createWidget: (_) =>
                  adminvenuedetailscreen.AdminVenueDetailScreen(venueId: id),
            ),
          );
        },
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) => buildFadeSlidePage(
          state,
          DeferredWidget(
            libraryLoader: adminsettingsscreen.loadLibrary,
            createWidget: (_) => adminsettingsscreen.AdminSettingsScreen(),
          ),
        ),
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) => buildFadeSlidePage(
          ...
          DeferredWidget(
            libraryLoader: _loadAlreadyAvailableAdminLibrary,
            createWidget: (_) => adminordersscreen.AdminOrdersScreen(),
          ),
        ),
      ),
    ],
