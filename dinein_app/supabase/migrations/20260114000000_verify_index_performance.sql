...
-- Date: 2026-01-14
-- Purpose: This file contains verification queries for manual testing
--          These queries should be run manually in the Supabase SQL Editor
--          DO NOT run as part of migrations
-- ============================================================================
...
-- NOTE: Run this manually in SQL Editor, not as migration
...
-- Check index usage statistics (run manually)
-- SELECT 
--   schemaname,
--   tablename,
--   indexname,
...
-- Check table statistics (run manually)
-- SELECT 
--   schemaname,
--   tablename,
...
-- Check index sizes (run manually)
-- SELECT 
--   schemaname,
--   tablename,
--   indexname,
