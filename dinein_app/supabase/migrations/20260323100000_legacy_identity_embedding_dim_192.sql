-- Expand the legacy identity embedding dimension from 128 → 192 to match
...
-- 1) Drop the index
drop index if exists public.idx_legacy_identity_face_embeddings_embedding_cosine;
...
-- 3) Recreate index
create index idx_legacy_identity_face_embeddings_embedding_cosine
