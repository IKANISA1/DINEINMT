...
void main() {
  testWidgets('cart screen shows empty state when cart count is 0', (WidgetTester tester) async {
    ...
    expect(find.text("Looks like you haven't added\nanything to your order yet."), findsOneWidget);
  });
}
